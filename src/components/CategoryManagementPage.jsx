...
import { Edit, Trash2, Plus, Save, X, FolderKanban, Folder, Filter, Lock, Banknote, Coins, Hash, BookOpen, Briefcase } from 'lucide-react';
  ...
  const renderCategorySection = (type, title) => (
    <div className="space-y-4">
      ...
      {categories[type].map(mainCat => {
        ...
        const isInvestments = mainCat.name === 'Investissements';
        ...
        if (isInvestments) specialClass = 'bg-purple-50 border-purple-200';
        ...
        if (isInvestments) textColor = 'text-purple-800';
        ...
        if (isInvestments) icon = <Briefcase className="w-4 h-4 text-purple-600" />;
