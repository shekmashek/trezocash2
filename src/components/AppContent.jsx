      ...
      const fetchInitialData = async () => {
        ...
        try {
          ...
          const [
            ...
            vatRatesRes, vatRegimesRes, taxConfigsRes,
          ] = await Promise.all([
          ...
          const responses = { projectsRes: { error: projectsError, data: projectsData }, tiersRes, loansRes, scenariosRes, entriesRes, actualsRes, paymentsRes, cashAccountsRes, scenarioEntriesRes, consolidatedViewsRes, collaboratorsRes, commentsRes, templatesRes, customCategoriesRes, vatRatesRes, vatRegimesRes, taxConfigsRes };
          ...
          const projectsForState = (projectsData || []).map(p => ({ 
              id: p.id, name: p.name, description: p.description, currency: p.currency, startDate: p.start_date, endDate: p.end_date, isArchived: p.is_archived, user_id: p.user_id, annualGoals: p.annual_goals, expenseTargets: p.expense_targets, display_unit: p.display_unit, decimal_places: p.decimal_places,
          ...
          dataDispatch({
            ...
            payload: {
              allProfiles: profilesData || [], settings, projects: projectsForState, tiers, loans, scenarios, consolidatedViews, collaborators, allComments, templates, vatRates, vatRegimes, taxConfigs,
