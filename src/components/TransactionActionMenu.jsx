...
import { FileX, DollarSign, HandCoins, Edit } from 'lucide-react';

const TransactionActionMenu = ({ menuState, onClose, onWriteOff, onPay, onEdit }) => {
    ...
    const isSettled = ['paid', 'received', 'written_off'].includes(transaction.status);
    ...
    const menuItems = [
        ...
        { label: 'Modifier', icon: Edit, action: onEdit, disabled: isSettled },
