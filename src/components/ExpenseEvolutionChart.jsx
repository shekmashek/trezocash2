...
const ExpenseEvolutionChart = () => {
    ...
    const chartData = useMemo(() => {
        ...
        const mainCategories = categories.expense.filter(mc => mc.subCategories && mc.subCategories.length > 0);
            ...
            const data = months.map(m => {
                ...
                const total = actualTransactions
                    .filter(tx => {
                        ...
                        return tx.type === 'payable' && mainCategoryName === mainCat.name;
                    })
    ...
    const getChartOptions = () => ({
        ...
        series: chartData.series.map(s => ({
            ...
            label: {
                ...
                position: 'inside',
                formatter: (params) => {
                    if (params.value > 100) { // Threshold to avoid clutter
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow">
            <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-semibold text-gray-800">Évolution des Sorties</h3>
            ...
            {hasData ? (
                ...
                <EmptyState
                    ...
                    message="Aucune sortie enregistrée pour la période sélectionnée pour afficher une évolution."
                />
            )}
        </div>
    );
